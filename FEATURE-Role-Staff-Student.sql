...
INSERT INTO `Parent_info` (`parent_ID`,`first_name`,`surname`,`address_line1`,`address_line2`,`town`,`county`,`postcode`,`contact_number`,`email`)
VALUES
...
INSERT INTO `Student_info` (`First_name`,`Last_name`,`Acadamic_year`,`Date_of_birth `,`Student_email`)
VALUES
  ("Wing","Miller",12,"30.08.05","miller.wing@redschool.com"),
  ("Brent","Gallegos",13,"25.07.05","gallegos-brent@redschool.com"),
  ("Barclay","Wilcox",13,"28.03.06","b.wilcox2148@redschool.com"),
  ("Melodie","Hoover",13,"06.01.06","h-melodie198@redschool.com"),
  ("Sebastian","Blankenship",12,"27.09.03","s_blankenship@redschool.com"),
  ("Brenden","Gray",12,"28.11.03","gray-brenden7237@redschool.com"),
  ("Yvette","Chandler",13,"08.02.05","yvette-chandler9077@redschool.com"),
  ("Avram","Barnes",12,"15.09.03","abarnes1633@redschool.com"),
  ("September","Simon",13,"25.07.06","s-simon@redschool.com"),
  ("Hayley","Warren",12,"31.12.04","hayley_warren@redschool.com"),
  ("Amena","Hudson",12,"28.07.04","hudson-amena3433@redschool.com"),
  ("Amir","Hays",13,"21.04.06","hays-amir5160@redschool.com"),
  ("Ezekiel","Mcfadden",13,"14.08.05","e.mcfadden6784@redschool.com"),
  ("Kristen","Pate",12,"27.05.04","pate-kristen1219@redschool.com"),
  ("Walker","Adams",13,"22.10.04","w.adams6610@redschool.com"),
  ("Dale","Aguilar",13,"28.01.06","daguilar@redschool.com"),
  ("Jakeem","Walters",12,"05.02.06","waltersjakeem@redschool.com"),
